...
export default function Home() {
  return (
    <div className="-mb-[calc(7rem+env(safe-area-inset-bottom))] flex h-[100svh] max-h-[100svh] flex-col overflow-hidden px-6 pt-[calc(3.75rem+env(safe-area-inset-top))] pb-[calc(5.75rem+env(safe-area-inset-bottom))] [@media(max-height:700px)]:pt-[calc(3.25rem+env(safe-area-inset-top))] [@media(max-height:700px)]:pb-[calc(5.25rem+env(safe-area-inset-bottom))]">
      ...
      <footer className="mx-auto w-full max-w-5xl shrink-0">
        <TrustedByMarquee />
      </footer>
    </div>
  );
